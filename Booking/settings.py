...
if not DEBUG:
    MINIO_ENDPOINT = config('MINIO_ENDPOINT', default='pasha-booking-storage-s3-console.darkube.app')
    MINIO_ACCESS_KEY = config('MINIO_ACCESS_KEY', 'V71llgCohS29c0FXn11kMiyFXxwQqQ5h')
    MINIO_SECRET_KEY = config('MINIO_SECRET_KEY', 'MUfZt2DOam6nVJmIzaMytAcq7W5is6n5')
